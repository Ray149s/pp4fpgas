...
\executeiffilenewer{figures/#1.svg}{images/#1.pdf}%
{inkscape figures/#1.svg --export-type=pdf --export-filename=images/#1.pdf --export-latex}%
\subimport{./images/}{#1.pdf_tex}%
}
\newcommand{\includesvgimg}[1]{%
\executeiffilenewer{figures/#1.svg}{images/#1.pdf}%
{inkscape figures/#1.svg --export-type=pdf --export-filename=images/#1.pdf}%
...
\input{chapters/fir}
\input{chapters/cordic}
\input{chapters/dft}
\input{chapters/fft}
\input{chapters/sparse_matrix_vector}
\input{chapters/matrix_multiplication}
\input{chapters/prefix_histogram}
\input{chapters/video}
\input{chapters/sorting}
\input{chapters/huffman_encoding}
\input{chapters/bnn}


%\part{Appendix: Wireless Systems Projects}
%\label{wirelessProjects}
%\input{chapters/wirelessBasics}
